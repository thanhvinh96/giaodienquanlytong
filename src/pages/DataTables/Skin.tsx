        ...
        <div className="space-y-6">
            ...
            <div className="panel">
                <div className="flex items-center justify-between mb-5">
                    ...
                    <input type="text" className="form-input w-auto" placeholder="Tìm kiếm" value={search1} onChange={(e) => setSearch1(e.target.value)} />
                </div>
                <div className="datatables">
                    <DataTable
                        highlightOnHover
            ...
            <div className="panel">
                <div className="flex items-center justify-between mb-5">
                    ...
                    <input type="text" className="form-input w-auto" placeholder="Tìm kiếm" value={search2} onChange={(e) => setSearch2(e.target.value)} />
                </div>
                <div className="datatables">
                    <DataTable
            ...
            <div className="panel">
                <div className="flex items-center justify-between mb-5">
                    ...
                    <input type="text" className="form-input w-auto" placeholder="Tìm kiếm" value={search3} onChange={(e) => setSearch3(e.target.value)} />
                </div>
                <div className="datatables">
                    <DataTable
            ...
            <div className="panel">
                <div className="flex items-center justify-between mb-5">
                    ...
                    <input type="text" className="form-input w-auto" placeholder="Tìm kiếm" value={search4} onChange={(e) => setSearch4(e.target.value)} />
                </div>
                <div className="datatables">
                    <DataTable
                        highlightOnHover
